...
import type { Automerge, API as WasmAPI, Actor as ActorId, Prop, ObjID, Change, ChangeMetadata, DecodedChange, Heads, MaterializeValue, JsSyncState, SyncMessage, Span, DecodedSyncMessage, UpdateSpansConfig } from "./wasm_types.js";
export type { ChangeMetadata, PutPatch, DelPatch, SpliceTextPatch, InsertPatch, IncPatch, Span, SyncMessage, UpdateSpansConfig, } from "./wasm_types.js";
/** @hidden **/
type API = WasmAPI;
 ...
 */
export declare function updateSpans<T>(doc: Doc<T>, path: Prop[], newSpans: Span[], config?: UpdateSpansConfig): void;
/**
 ...
 * @returns
 */
export declare function saveBundle(doc: Doc<unknown>, hashes: string[]): Uint8Array;
/**
 * EXPERIMENTAL: Load a bundle of changes to examine them
 * @experimental
 * @param bundle - The encoded bundle to read
 */
export declare function readBundle(bundle: Uint8Array): {
