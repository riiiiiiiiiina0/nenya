 ...
 * @type {{ STATUS: 'optionsBackup:getStatus', BACKUP_NOW: 'optionsBackup:backupNow', RESTORE_NOW: 'optionsBackup:restoreNow', RESET_DEFAULTS: 'optionsBackup:resetDefaults', RESTORE_AFTER_LOGIN: 'optionsBackup:restoreAfterLogin', SYNC_AFTER_LOGIN: 'optionsBackup:syncAfterLogin' }}
 */
